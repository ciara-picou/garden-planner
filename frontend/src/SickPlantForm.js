...
<Form.Row className="align-items-center">
  <Col xs="auto">
      <Form.Group controlId="post-sick-plant">
          <Form.Label class="text-white">Post Photos of Your Sick Plants Here</Form.Label>
          <Form.Control size="lg" type="photo" placeholder="Upload a photo" />
      </Form.Group>
  {/* <Form.Group>
          <Form.File id="exampleFormControlFile1" label="Example file input" />
      </Form.Group> */}
<Form.Group controlId="post-sick-plant">
  <Form.Control size="lg" type="content" placeholder="Ask the Community" />
